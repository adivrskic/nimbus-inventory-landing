export const BLOG_POSTS = [
     ...
     ────────────────────────────────────────────────────────────────── */
  {
    ...
    desc: "We turned on the anomaly detection layer for every Nimbus customer on April 1st. Here are five real incidents it surfaced, anonymized but otherwise unmodified.",
    content: [
      {
        type: "p",
     ...
     ────────────────────────────────────────────────────────────────── */
  {
    ...
    content: [
      ...
      {
        type: "p",
        text: "We have an ABC report. You can run an ABC analysis if you want. But the default counting suggestion in Nimbus has never been ABC, and we'd like to make the case for why.",
      },
     ...
     ────────────────────────────────────────────────────────────────── */
  {
    ...
    content: [
      ...
      {
        type: "p",
        text: "Reese is the COO of Mercantile Coffee, a specialty roaster and distributor we'd been onboarding across four warehouses in Oregon and Washington. They roast about 380 tons of coffee a year. They were one of our first multi-site customers. And by their sixth week with Nimbus, they were ready to send us packing.",
      },
      {
        type: "p",
