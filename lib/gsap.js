...
if (typeof window !== "undefined") {
  ...
  /* Web fonts swap in after the first triggers are computed, and the
     resulting reflow can move a trigger point past the current scroll
     position — an above-the-fold reveal would then sit waiting for a
     scroll that never comes. Recompute once the fonts settle; the
     backstop above then releases anything already in range. */
