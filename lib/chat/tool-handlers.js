...
// Email shape is validated with the shared EMAIL_RE imported from
// lib/validation — same rule the contact + demo form validators use, so
// chat-captured leads accept exactly the same addresses as form leads.
