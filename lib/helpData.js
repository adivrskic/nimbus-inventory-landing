    ...
    articles: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "p",
            text: "Scan any barcode not yet in your system and Nimbus will prompt you to create a new product. Fill in the name, SKU, and optional fields — the barcode is automatically linked.",
          },
          { type: "h2", text: "CSV import" },
          {
            type: "p",
            text: "Go to Settings → Import/Export → Import Products. Download the CSV template, fill in your product data, and upload. Nimbus will validate the file and show a preview before importing.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Nimbus scanning works with your device's built-in camera — no special hardware required. For best results, ensure your camera lens is clean and you have adequate lighting.",
          },
          { type: "h2", text: "Supported formats" },
          {
            type: "p",
            text: "Nimbus supports Code 128, Code 39, EAN-13, UPC-A, QR codes, and Data Matrix. The scanner automatically detects the format — no configuration needed.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "p",
            text: "Walk to each location and scan the location barcode. Nimbus shows the expected quantity — enter the actual count. If they match, the location is confirmed. If they differ, it's flagged for review.",
          },
          {
            type: "p",
    ...
    articles: [
      {
        ...
        content: [
          {
            type: "p",
            text: "Nimbus recognizes all major barcode formats automatically: Code 128, Code 39, EAN-13, EAN-8, UPC-A, UPC-E, QR Code, Data Matrix, ITF-14, and Codabar.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Nimbus supports eight scan actions: Pick (remove from location for order), Putaway (place into location), Receive (add new stock), Relocate (move between locations), Count (cycle count verification), Adjust (manual quantity change), Ship (mark as shipped), and Return (process incoming return).",
          },
          {
            type: "p",
            text: "Select the action before scanning, or let Nimbus auto-detect based on context. If you're in a cycle count session, scans automatically register as counts.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "When you scan a barcode that doesn't match any existing product, Nimbus prompts you to create a new one. Enter the product name, SKU, and any custom fields.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "p",
            text: "Nimbus updates both locations instantly. The activity log records who moved what, when, from where, and to where — providing a complete audit trail.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "p",
            text: "Nimbus validates every row before importing. Common issues: duplicate SKUs, missing required fields, invalid location codes. The preview screen shows exactly what will be created or updated, with errors highlighted in red.",
          },
        ],
      },
    ],
    ...
    articles: [
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Spatial mapping builds automatically from your team's scan activity. No additional setup is required — just use Nimbus normally and the map refines itself.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Go to Settings → Alerts → Low Stock. Set global thresholds or per-product minimums. When stock drops below the threshold, Nimbus sends a push notification and email to designated team members.",
          },
          {
            type: "p",
    ...
    articles: [
      {
        ...
        content: [
          {
            type: "p",
            text: "Go to Settings → Integrations → QuickBooks. Click 'Connect' and sign in to your QuickBooks Online account. Grant Nimbus permission to read and write inventory data.",
          },
          {
            type: "p",
            text: "After connecting, map your Nimbus products to QuickBooks inventory items. Nimbus will auto-match by SKU where possible. Inventory movements will then automatically create journal entries in QuickBooks.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Connect your Shopify store in Settings → Integrations → Shopify. Enter your store URL and authorize the connection. Nimbus syncs inventory levels bidirectionally every 30 seconds.",
          },
          {
            type: "p",
            text: "When a Shopify order is placed, warehouse stock decrements instantly. When you receive new stock in Nimbus, Shopify product availability updates automatically. Multi-location Shopify stores are fully supported.",
          },
        ],
      },
      {
        ...
        content: [
          ...
          {
            type: "p",
            text: "Once connected, picked orders in Nimbus automatically create shipments in ShipStation. Tracking numbers from ShipStation push back to Nimbus and connected sales channels.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "The Nimbus API uses Bearer token authentication. Generate an API key in Settings → API → Generate Key. Include the key in every request header: Authorization: Bearer YOUR_API_KEY.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Search for 'Nimbus WMS' in the Zapier app directory. Connect your account using your API key. Available triggers: New Scan, Low Stock Alert, Order Complete, Count Finished.",
          },
          {
            type: "p",
    ...
    articles: [
      {
        ...
        content: [
          {
            type: "p",
            text: "Nimbus offers three plans: Starter (free for 1 user, 500 products), Pro ($49/mo for 10 users, unlimited products, AI features), and Enterprise (custom pricing, unlimited users, SSO, dedicated support).",
          },
          {
            type: "p",
            text: "All plans include barcode scanning, inventory management, and mobile access. AI features (voice commands, predictive analytics, spatial mapping) require Pro or Enterprise.",
          },
        ],
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Go to Settings → Billing → Change Plan. Select your new plan and confirm. Upgrades take effect immediately — you'll be prorated for the remainder of your current billing cycle.",
          },
          {
            type: "p",
            text: "When upgrading from Starter to Pro, all AI features are enabled instantly. Your existing data, warehouse configurations, and team members carry over unchanged.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Enable 2FA in Settings → Security → Two-Factor Authentication. Nimbus supports authenticator apps (Google Authenticator, Authy) and SMS codes.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        content: [
          {
            type: "p",
            text: "Cancel your subscription in Settings → Billing → Cancel Plan. Your account remains active until the end of the current billing cycle. After that, it reverts to the free Starter plan.",
          },
          {
            type: "p",
            text: "All your data is preserved for 90 days after cancellation. You can reactivate at any time during this period. Refunds are available for annual plans within the first 30 days.",
          },
        ],
      },
    ],
