    ...
    articles: [
      {
        ...
        content: [
          {
            type: "p",
            text: "Nautilus offers three plans: Starter (free for 1 user, 500 products), Pro ($49/mo for 10 users, unlimited products, AI features), and Enterprise (custom pricing, unlimited users, SSO, dedicated support).",
          },
          {
            type: "p",
